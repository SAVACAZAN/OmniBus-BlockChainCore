...
\item 
directory \doxymbox{\hyperlink{dir_2494761adabb76e6fbe9f5799126b86e}{node\+\_\+modules}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5759}{}\doxysubsection{\texorpdfstring{Chokidar \+[!\+[Weekly downloads]\+(\href{https://img.shields.io/npm/dw/chokidar.svg}{\texttt{https:\+/\+/\+img.\+shields.\+io/\+npm/\+dw/\+chokidar.\+svg}})]\+(\href{https://github.com/paulmillr/chokidar}{\texttt{https:\+/\+/\+github.\+com/\+paulmillr/\+chokidar}}) \+[!\+[Yearly downloads]\+(\href{https://img.shields.io/npm/dy/chokidar.svg}{\texttt{https:\+/\+/\+img.\+shields.\+io/\+npm/\+dy/\+chokidar.\+svg}})]\+(\href{https://github.com/paulmillr/chokidar}{\texttt{https:\+/\+/\+github.\+com/\+paulmillr/\+chokidar}})}{Chokidar \+[!\+[Weekly downloads]\+(\href{https://img.shields.io/npm/dw/chokidar.svg}{\texttt{https:\+/\+/\+img.\+shields.\+io/\+npm/\+dw/\+chokidar.\+svg}})]\+(\href{https://github.com/paulmillr/chokidar}{\texttt{https:\+/\+/\+github.\+com/\+paulmillr/\+chokidar}}) \+[!\+[Yearly downloads]\+(\href{https://img.shields.io/npm/dy/chokidar.svg}{\texttt{https:\+/\+/\+img.\+shields.\+io/\+npm/\+dy/\+chokidar.\+svg}})]\+(\href{https://github.com/paulmillr/chokidar}{\texttt{https:\+/\+/\+github.\+com/\+paulmillr/\+chokidar}})}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5759}
\begin{quote}
Minimal and efficient cross-\/platform file watching library \end{quote}


\href{https://www.npmjs.com/package/chokidar}{\texttt{}}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5760}{}\doxysubsection{\texorpdfstring{Why?}{Why?}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5760}
...
Version 3 is out! Check out our blog post about it:\+ \href{https://paulmillr.com/posts/chokidar-3-save-32tb-of-traffic/}{\texttt{Chokidar 3:\+ How to save 32TB of traffic every week}}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5761}{}\doxysubsection{\texorpdfstring{How?}{How?}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5761}
...
\end{DoxyCode}
\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5763}{}\doxysubsection{\texorpdfstring{API}{API}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5763}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5764}{}\doxysubsubsubsection{\texorpdfstring{Persistence}{Persistence}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5764}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5765}{}\doxysubsubsubsection{\texorpdfstring{Path filtering}{Path filtering}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5765}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5766}{}\doxysubsubsubsection{\texorpdfstring{Performance}{Performance}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5766}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5767}{}\doxysubsubsubsection{\texorpdfstring{Errors}{Errors}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5767}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5768}{}\doxysubsubsection{\texorpdfstring{Methods \& Events}{Methods \& Events}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5768}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5769}{}\doxysubsection{\texorpdfstring{CLI}{CLI}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5769}
If you need a CLI interface for your file watching, check out \href{https://github.com/open-cli-tools/chokidar-cli}{\texttt{chokidar-\/cli}}, allowing you to execute a command on each change, or get a stdio stream of change events.\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5770}{}\doxysubsection{\texorpdfstring{Install Troubleshooting}{Install Troubleshooting}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5770}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5771}{}\doxysubsection{\texorpdfstring{Changelog}{Changelog}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5771}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5772}{}\doxysubsection{\texorpdfstring{Also}{Also}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5772}
Why was chokidar named this way? What\textquotesingle{}s the meaning behind it?

\texorpdfstring{$>$}{>}Chowkidar is a transliteration of a Hindi word meaning \textquotesingle{}watchman, gatekeeper\textquotesingle{}, चौकीदार. This ultimately comes from Sanskrit \+\_\+ चतुष्क\+\_\+ (crossway, quadrangle, consisting-\/of-\/four). This word is also used in other languages like Urdu as (چوکیدار) which is widely used in Pakistan and India.\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5773}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md5773}
