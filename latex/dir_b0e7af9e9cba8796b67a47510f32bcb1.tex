...
\hypertarget{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4491}{}\doxysubsection{\texorpdfstring{@jridgewell/\+remapping}{@jridgewell/\+remapping}}\label{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4491}
\begin{quote}
...
With remapping, none of your source code transformations need to be aware of the input\textquotesingle{}s sourcemap, they only need to generate an output sourcemap. This greatly simplifies building custom transformations (think a find-\/and-\/replace).\hypertarget{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4492}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4492}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ @jridgewell/remapping}

\end{DoxyCode}
\hypertarget{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4493}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4493}
...
\begin{DoxyEnumerate}
\item {\ttfamily "{}transformed.\+js"{}}, the first source file pointer in the {\ttfamily minified\+Transformed\+Map}. \doxylink{namespace_we}{We} return the associated sourcemap for it (its a transformed file, after all) so that sourcemap locations can be traced through it into the source files it represents.
...
\end{DoxyCode}
\hypertarget{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4495}{}\doxysubsubsection{\texorpdfstring{Advanced control of the loading graph}{Advanced control of the loading graph}}\label{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4495}
\hypertarget{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4496}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily source}}{{\ttfamily source}}}\label{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4496}
...
\end{DoxyCode}
\hypertarget{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4497}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily content}}{{\ttfamily content}}}\label{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4497}
...
\end{DoxyCode}
\hypertarget{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4498}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4498}
\hypertarget{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4499}{}\doxysubsubsubsection{\texorpdfstring{exclude\+Content}{exclude\+Content}}\label{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4499}
By default, {\ttfamily exclude\+Content} is {\ttfamily false}. Passing {\ttfamily \{ exclude\+Content:\+ true \}} will exclude the {\ttfamily sources\+Content} field from the returned sourcemap. This is mainly useful when you want to reduce the size out the sourcemap.\hypertarget{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4500}{}\doxysubsubsubsection{\texorpdfstring{decoded\+Mappings}{decoded\+Mappings}}\label{dir_b0e7af9e9cba8796b67a47510f32bcb1_autotoc_md4500}
