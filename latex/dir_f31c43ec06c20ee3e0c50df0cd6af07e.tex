\doxysection{frontend/\+node\+\_\+modules/\+d3-\/color Directory Reference}
\hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e}{}\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e}\index{frontend/node\_modules/d3-\/color Directory Reference@{frontend/node\_modules/d3-\/color Directory Reference}}
Directory dependency graph for d3-\/color:\+
% FIG 0


\doxysubsection{Detailed Description}
\hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md5958}{}\doxysubsection{\texorpdfstring{d3-\/color}{d3-\/color}}\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md5958}
...
In addition to the ubiquitous and machine-\/friendly \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_rgb}{RGB}RGB and \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_hsl}{HSL}HSL color space, d3-\/color supports color spaces that are designed for humans:\+


\begin{DoxyItemize}
\item \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_lab}{CIELAB}CIELAB
\end{DoxyItemize}({\itshape a.\+k.\+a.} “\+Lab”)
\begin{DoxyItemize}
\item \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_lch}{CIELCh\textsubscript{ab}}CIELCh\textsubscript{ab}
\end{DoxyItemize}({\itshape a.\+k.\+a.} “\+LCh” or “\+HCL”)
\begin{DoxyItemize}
\item Dave Green’s \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_cubehelix}{Cubehelix}Cubehelix
\end{DoxyItemize}

Cubehelix features monotonic lightness, while CIELAB and its polar form CIELCh\textsubscript{ab} are perceptually uniform.\hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md5959}{}\doxysubsection{\texorpdfstring{Extensions}{Extensions}}\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md5959}
...
\end{DoxyItemize}\hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md5960}{}\doxysubsection{\texorpdfstring{Installing}{Installing}}\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md5960}
...
\href{https://observablehq.com/collection/@d3/d3-color}{\texttt{Try d3-\/color in your browser.}}\hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md5961}{}\doxysubsection{\texorpdfstring{API Reference}{API Reference}}\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_autotoc_md5961}
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color}%
...
Parses the specified \href{http://www.w3.org/TR/css3-color/\#colorunits}{\texttt{CSS Color Module Level 3}} {\itshape specifier} string, returning an \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_rgb}{RGB}RGB or \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_hsl}{HSL}HSL color, along with \href{https://www.w3.org/TR/css-color-4/\#hex-notation}{\texttt{CSS Color Module Level 4 hex}} {\itshape specifier} strings. If the specifier was not valid, null is returned. Some examples:\+
...
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_opacity}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_opacity}%
\# {\itshape color}.{\bfseries{opacity}}

This color’s opacity, typically in the range \+[0, 1]\+.

\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_rgb}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_rgb}%
\# {\itshape color}.{\bfseries{rgb}}() \href{https://github.com/d3/d3-color/blob/master/src/color.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}

Returns the \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_rgb}{RGB equivalent}RGB equivalent of this color. For RGB colors, that’s {\ttfamily this}.

\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_copy}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_copy}%
\# {\itshape color}.{\bfseries{copy}}(\+[{\itshape values}]\+) \href{https://github.com/d3/d3-color/blob/master/src/color.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}
...
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_brighter}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_brighter}%
\# {\itshape color}.{\bfseries{brighter}}(\+[{\itshape k}]\+) \href{https://github.com/d3/d3-color/blob/master/src/color.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}
...
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_darker}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_darker}%
\# {\itshape color}.{\bfseries{darker}}(\+[{\itshape k}]\+) \href{https://github.com/d3/d3-color/blob/master/src/color.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}
...
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_displayable}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_displayable}%
...
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_formatHex}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_formatHex}%
...
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_formatHsl}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_formatHsl}%
...
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_formatRgb}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_formatRgb}%
...
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_toString}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_toString}%
...
An alias for \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_formatRgb}{\texorpdfstring{$\ast$}{*}color\texorpdfstring{$\ast$}{*}.format\+Rgb}{\itshape color}.format\+Rgb.

\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_rgb}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_rgb}%
\# d3.{\bfseries{rgb}}({\itshape r}, {\itshape g}, {\itshape b}\+[, {\itshape opacity}]\+) \href{https://github.com/d3/d3-color/blob/master/src/color.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}~\newline
...
If {\itshape r}, {\itshape g} and {\itshape b} are specified, these represent the channel values of the returned color; an {\itshape opacity} may also be specified. If a CSS Color Module Level 3 {\itshape specifier} string is specified, it is parsed and then converted to the RGB color space. See \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color}{color}color for examples. If a \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color}{\texorpdfstring{$\ast$}{*}color\texorpdfstring{$\ast$}{*}}{\itshape color} instance is specified, it is converted to the RGB color space using \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_rgb}{\texorpdfstring{$\ast$}{*}color\texorpdfstring{$\ast$}{*}.rgb}{\itshape color}.rgb. Note that unlike \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_color_rgb}{\texorpdfstring{$\ast$}{*}color\texorpdfstring{$\ast$}{*}.rgb}{\itshape color}.rgb this method {\itshape always} returns a new instance, even if {\itshape color} is already an RGB color.

\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_rgb_clamp}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_rgb_clamp}%
\# {\itshape rgb}.{\bfseries{clamp}}() \href{https://github.com/d3/d3-color/blob/master/src/color.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}

Returns a new RGB color where the {\ttfamily r}, {\ttfamily g}, and {\ttfamily b} channels are clamped to the range \+[0, 255]\+ and rounded to the nearest integer value, and the {\ttfamily opacity} is clamped to the range \+[0, 1]\+.

\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_hsl}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_hsl}%
\# d3.{\bfseries{hsl}}({\itshape h}, {\itshape s}, {\itshape l}\+[, {\itshape opacity}]\+) \href{https://github.com/d3/d3-color/blob/master/src/color.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}~\newline
...
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_gray}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_gray}%
\# d3.{\bfseries{gray}}({\itshape l}\+[, {\itshape opacity}]\+) \href{https://github.com/d3/d3-color/blob/master/src/lab.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}~\newline


Constructs a new \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_lab}{CIELAB}CIELAB color with the specified {\itshape l} value and {\itshape a} = {\itshape b} = 0.

\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_hcl}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_hcl}%
\# d3.{\bfseries{hcl}}({\itshape h}, {\itshape c}, {\itshape l}\+[, {\itshape opacity}]\+) \href{https://github.com/d3/d3-color/blob/master/src/lab.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}~\newline
 \href{\#hcl}{\texttt{\#}} d3.{\bfseries{hcl}}({\itshape specifier})~\newline
 \href{\#hcl}{\texttt{\#}} d3.{\bfseries{hcl}}({\itshape color})~\newline


Equivalent to \doxylink{dir_f31c43ec06c20ee3e0c50df0cd6af07e_lch}{d3.lch}d3.\+lch, but with reversed argument order.

\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_lch}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_lch}%
\# d3.{\bfseries{lch}}({\itshape l}, {\itshape c}, {\itshape h}\+[, {\itshape opacity}]\+) \href{https://github.com/d3/d3-color/blob/master/src/lab.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}~\newline
 \href{\#lch}{\texttt{\#}} d3.{\bfseries{lch}}({\itshape specifier})~\newline
 \href{\#lch}{\texttt{\#}} d3.{\bfseries{lch}}({\itshape color})~\newline


Constructs a new \href{https://en.wikipedia.org/wiki/CIELAB_color_space\#Cylindrical_representation:_CIELCh_or_CIEHLC}{\texttt{CIELCh\textsubscript{ab}}} color. The channel values are exposed as {\ttfamily l}, {\ttfamily c} and {\ttfamily h} properties on the returned instance. Use the \href{http://bl.ocks.org/mbostock/3e115519a1b495e0bd95}{\texttt{CIELCh\textsubscript{ab} color picker}} to explore this color space. The value of {\itshape l} is typically in the range \+[0, 100]\+, {\itshape c} is typically in \+[0, 230]\+, and {\itshape h} is typically in \+[0, 360).
...
\label{dir_f31c43ec06c20ee3e0c50df0cd6af07e_cubehelix}%
\Hypertarget{dir_f31c43ec06c20ee3e0c50df0cd6af07e_cubehelix}%
\# d3.{\bfseries{cubehelix}}({\itshape h}, {\itshape s}, {\itshape l}\+[, {\itshape opacity}]\+) \href{https://github.com/d3/d3-color/blob/master/src/cubehelix.js}{\texttt{\texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>}}}~\newline
