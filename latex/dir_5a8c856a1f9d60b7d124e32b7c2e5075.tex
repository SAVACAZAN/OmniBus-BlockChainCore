...
\hypertarget{dir_5a8c856a1f9d60b7d124e32b7c2e5075_autotoc_md6996}{}\doxysubsection{\texorpdfstring{gensync}{gensync}}\label{dir_5a8c856a1f9d60b7d124e32b7c2e5075_autotoc_md6996}
...
Take for example {\ttfamily fs.\+read\+File} and {\ttfamily fs.\+read\+File\+Sync}, if you\textquotesingle{}re writing an API that loads a file and then performs a synchronous operation on the data, it can be frustrating to maintain two parallel functions.\hypertarget{dir_5a8c856a1f9d60b7d124e32b7c2e5075_autotoc_md6997}{}\doxysubsection{\texorpdfstring{Example}{Example}}\label{dir_5a8c856a1f9d60b7d124e32b7c2e5075_autotoc_md6997}
...
\end{DoxyCode}
 or potentially expose one of the async versions as the default, with a {\ttfamily .\doxylink{namespacesync}{sync}} property on the function to expose the synchronous version. 
\begin{DoxyCode}{0}
