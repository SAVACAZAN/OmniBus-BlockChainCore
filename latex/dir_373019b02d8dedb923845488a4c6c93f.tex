\doxysection{frontend/\+node\+\_\+modules/\+terser/\+node\+\_\+modules/\+commander Directory Reference}
\hypertarget{dir_373019b02d8dedb923845488a4c6c93f}{}\label{dir_373019b02d8dedb923845488a4c6c93f}\index{frontend/node\_modules/terser/node\_modules/commander Directory Reference@{frontend/node\_modules/terser/node\_modules/commander Directory Reference}}
Directory dependency graph for commander:\+
% FIG 0


\doxysubsection{Detailed Description}
\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9104}{}\doxysubsection{\texorpdfstring{Commander.\+js}{Commander.\+js}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9104}
...
The complete solution for \href{http://nodejs.org}{\texttt{node.\+js}} command-\/line interfaces, inspired by Ruby\textquotesingle{}s \href{https://github.com/commander-rb/commander}{\texttt{commander}}. ~\newline
 \href{http://tj.github.com/commander.js/}{\texttt{API documentation}}\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9105}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9105}
\begin{DoxyVerb}$ npm install commander
\end{DoxyVerb}
\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9106}{}\doxysubsection{\texorpdfstring{Option parsing}{Option parsing}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9106}
...
To get string arguments from options you will need to use angle brackets \texorpdfstring{$<$}{<}\texorpdfstring{$>$}{>} for required inputs or square brackets \+[]\+ for optional inputs.

e.\+g. {\ttfamily .option(\textquotesingle{}-\/m -\/-\/myarg \+[my\+Var]\+\textquotesingle{}, \textquotesingle{}my super cool description\textquotesingle{})}

Then to access the input if it was passed in.

e.\+g. {\ttfamily var my\+Input = program.\+myarg}

{\bfseries{NOTE}}:\+ If you pass a argument without using brackets the example above will return true and not the value passed in.\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9107}{}\doxysubsection{\texorpdfstring{Version option}{Version option}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9107}
...
The version flags can be named anything, but the long option is required.\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9108}{}\doxysubsection{\texorpdfstring{Command-\/specific options}{Command-\/specific options}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9108}
...
A command\textquotesingle{}s options are validated when the command is used. Any unknown options will be reported as an error. However, if an action-\/based command does not define an action, then the options are not validated.\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9109}{}\doxysubsection{\texorpdfstring{Coercion}{Coercion}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9109}
...
\end{DoxyCode}
\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9110}{}\doxysubsection{\texorpdfstring{Regular Expression}{Regular Expression}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9110}
...
\end{DoxyCode}
\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9111}{}\doxysubsection{\texorpdfstring{Variadic arguments}{Variadic arguments}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9111}
...
\end{DoxyCode}
 Angled brackets (e.\+g. {\ttfamily \texorpdfstring{$<$}{<}cmd\texorpdfstring{$>$}{>}}) indicate required input. Square brackets (e.\+g. {\ttfamily \+[env]\+}) indicate optional input.\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9113}{}\doxysubsection{\texorpdfstring{Git-\/style sub-\/commands}{Git-\/style sub-\/commands}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9113}
...
If the program is designed to be installed globally, make sure the executables have proper modes, like {\ttfamily 755}.\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9114}{}\doxysubsubsection{\texorpdfstring{{\ttfamily -\/-\/harmony}}{{\ttfamily -\/-\/harmony}}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9114}
You can enable {\ttfamily -\/-\/harmony} option in two ways:\+
\begin{DoxyItemize}
\item Use {\ttfamily \#! /\+usr/\+bin/\+env \doxylink{namespacenode}{node} -\/-\/harmony} in the sub-\/commands scripts. Note some os version don’t support this pattern.
...
\end{DoxyItemize}\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9115}{}\doxysubsection{\texorpdfstring{Automated --help}{Automated --help}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9115}
...
\end{DoxyCode}
\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9116}{}\doxysubsection{\texorpdfstring{Custom help}{Custom help}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9116}
...
\end{DoxyCode}
\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9117}{}\doxysubsection{\texorpdfstring{.output\+Help(cb)}{.output\+Help(cb)}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9117}
...
\end{DoxyCode}
\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9118}{}\doxysubsection{\texorpdfstring{.help(cb)}{.help(cb)}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9118}
Output help information and exit immediately. Optional callback cb allows post-\/processing of help text before it is displayed.\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9119}{}\doxysubsection{\texorpdfstring{Custom event listeners}{Custom event listeners}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9119}
...
\end{DoxyCode}
\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9120}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9120}
...
More Demos can be found in the \href{https://github.com/tj/commander.js/tree/master/examples}{\texttt{examples}} directory.\hypertarget{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9121}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_373019b02d8dedb923845488a4c6c93f_autotoc_md9121}
