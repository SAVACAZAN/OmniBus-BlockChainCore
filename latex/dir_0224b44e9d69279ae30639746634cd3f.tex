...
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8850}{}\doxysubsection{\texorpdfstring{Sucrase}{Sucrase}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8850}
\href{https://github.com/alangpierce/sucrase/actions}{\texttt{}} \href{https://www.npmjs.com/package/sucrase}{\texttt{}} \href{https://packagephobia.now.sh/result?p=sucrase}{\texttt{}} \+[]\+(LICENSE) \href{https://gitter.im/sucrasejs/Lobby}{\texttt{}}\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8851}{}\doxysubsection{\texorpdfstring{\href{https://sucrase.io}{\texttt{Try it out}}}{\href{https://sucrase.io}{\texttt{Try it out}}}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8851}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8852}{}\doxysubsection{\texorpdfstring{Quick usage}{Quick usage}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8852}
...
\end{DoxyCode}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8853}{}\doxysubsection{\texorpdfstring{Project overview}{Project overview}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8853}
...
Details:\+ Measured on July 2022. Tools run in single-\/threaded mode without warm-\/up. See the \href{https://github.com/alangpierce/sucrase/blob/main/benchmark/benchmark.ts}{\texttt{benchmark code}} for methodology and caveats.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8854}{}\doxysubsection{\texorpdfstring{Transforms}{Transforms}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8854}
...
When the {\ttfamily imports} transform is {\itshape not} specified (i.\+e. when targeting ESM), the {\ttfamily inject\+Create\+Require\+For\+Import\+Require} option can be specified to transform TS {\ttfamily import foo = require("{}foo"{});} in a way that matches the \href{https://devblogs.microsoft.com/typescript/announcing-typescript-4-7/\#commonjs-interoperability}{\texttt{Type\+Script 4.\+7 behavior}} with {\ttfamily \doxylink{namespacemodule}{module}:\+ nodenext}.
...
\end{DoxyItemize}\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8856}{}\doxysubsubsection{\texorpdfstring{JSX Options}{JSX Options}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8856}
...
\end{DoxyItemize}\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8857}{}\doxysubsubsection{\texorpdfstring{Legacy Common\+JS interop}{Legacy Common\+JS interop}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8857}
...
\end{DoxyItemize}\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8858}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8858}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8859}{}\doxysubsubsection{\texorpdfstring{Tool integrations}{Tool integrations}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8859}
...
\end{DoxyItemize}\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8860}{}\doxysubsubsection{\texorpdfstring{Usage in Node}{Usage in Node}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8860}
...
\item When invoking Node:\+ {\ttfamily \doxylink{namespacenode}{node} -\/r sucrase/\+register main.\+ts}
\item As a separate binary:\+ {\ttfamily sucrase-\/node main.\+ts}
\end{DoxyItemize}

Options can be passed to the require hook via a {\ttfamily SUCRASE\+\_\+\+OPTIONS} environment variable holding a JSON string of options.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8861}{}\doxysubsubsection{\texorpdfstring{Compiling a project to JS}{Compiling a project to JS}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8861}
...
\end{DoxyCode}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8862}{}\doxysubsubsection{\texorpdfstring{Usage from code}{Usage from code}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8862}
...
\end{DoxyCode}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8863}{}\doxysubsection{\texorpdfstring{What Sucrase is not}{What Sucrase is not}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8863}
...
See the Project Vision document for more details on the philosophy behind Sucrase.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8864}{}\doxysubsection{\texorpdfstring{Motivation}{Motivation}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8864}
...
Because Sucrase works on a lower level and uses a custom parser for its use case, it is much faster than Babel.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8865}{}\doxysubsection{\texorpdfstring{Contributing}{Contributing}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8865}
Contributions are welcome, whether they be bug reports, PRs, docs, tests, or anything else! Please take a look through the \doxylink{_c_o_n_t_r_i_b_u_t_i_n_g_8md}{Contributing Guide} to learn how to get started.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8866}{}\doxysubsection{\texorpdfstring{License and attribution}{License and attribution}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8866}
Sucrase is MIT-\/licensed. A large part of Sucrase is based on a fork of the \href{https://github.com/babel/babel/tree/main/packages/babel-parser}{\texttt{Babel parser}}, which is also MIT-\/licensed.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8867}{}\doxysubsection{\texorpdfstring{Why the name?}{Why the name?}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md8867}
