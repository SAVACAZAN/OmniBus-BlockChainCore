\doxysection{frontend/\+node\+\_\+modules/\+source-\/map-\/support Directory Reference}
\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98}{}\label{dir_8875c2d206357c9af6171c14ab0e0c98}\index{frontend/node\_modules/source-\/map-\/support Directory Reference@{frontend/node\_modules/source-\/map-\/support Directory Reference}}
Directory dependency graph for source-\/map-\/support:\+
% FIG 0


\doxysubsection{Detailed Description}
\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8750}{}\doxysubsection{\texorpdfstring{Source Map Support}{Source Map Support}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8750}
\href{https://travis-ci.org/evanw/node-source-map-support}{\texttt{}}

This module provides source map support for stack traces in node via the \href{https://github.com/v8/v8/wiki/Stack-Trace-API}{\texttt{V8 stack trace API}}. It uses the \href{https://github.com/mozilla/source-map}{\texttt{source-\/map}} module to replace the paths and line numbers of source-\/mapped files with their original paths and line numbers. The output mimics node\textquotesingle{}s stack trace format with the goal of making every compile-\/to-\/\+JS language more of a first-\/class citizen. Source maps are completely general (not specific to any one language) so you can use source maps with multiple compile-\/to-\/\+JS languages in the same node process.\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8751}{}\doxysubsection{\texorpdfstring{Installation and Usage}{Installation and Usage}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8751}
\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8752}{}\doxysubsubsubsection{\texorpdfstring{Node support}{Node support}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8752}
...
From here you have two options.\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8753}{}\doxysubsubsubsubsection{\texorpdfstring{CLI Usage}{CLI Usage}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8753}

\begin{DoxyCode}{0}
\DoxyCodeLine{node\ -\/r\ source-\/map-\/support/register\ compiled.js}

\end{DoxyCode}
\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8754}{}\doxysubsubsubsubsection{\texorpdfstring{Programmatic Usage}{Programmatic Usage}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8754}
...
\end{DoxyCode}
\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8755}{}\doxysubsubsubsection{\texorpdfstring{Browser support}{Browser support}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8755}
...
\end{DoxyCode}
\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8756}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8756}
...
This monkey patches the {\ttfamily require} module loading chain, so is not enabled by default and is not recommended for any sort of production usage.\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8757}{}\doxysubsection{\texorpdfstring{Demos}{Demos}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8757}
\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8758}{}\doxysubsubsubsection{\texorpdfstring{Basic Demo}{Basic Demo}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8758}
original.\+js:\+
...
\end{DoxyCode}
\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8759}{}\doxysubsubsubsection{\texorpdfstring{Type\+Script Demo}{Type\+Script Demo}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8759}
demo.\+ts:\+
...
There is also the option to use {\ttfamily -\/r source-\/map-\/support/\+register} with typescript, without the need add the {\ttfamily require(\textquotesingle{}source-\/map-\/support\textquotesingle{}).install()} in the code base:\+
...
\end{DoxyCode}
\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8760}{}\doxysubsubsubsection{\texorpdfstring{Coffee\+Script Demo}{Coffee\+Script Demo}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8760}
demo.\+coffee:\+
...
\end{DoxyCode}
\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8761}{}\doxysubsection{\texorpdfstring{Tests}{Tests}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8761}
...
\end{DoxyItemize}\hypertarget{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8762}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_8875c2d206357c9af6171c14ab0e0c98_autotoc_md8762}
