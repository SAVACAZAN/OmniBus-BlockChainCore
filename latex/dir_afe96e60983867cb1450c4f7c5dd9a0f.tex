...
\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5200}{}\doxysubsection{\texorpdfstring{Acorn}{Acorn}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5200}
A tiny, fast Java\+Script parser written in Java\+Script.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5201}{}\doxysubsection{\texorpdfstring{Community}{Community}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5201}
...
You are welcome to \href{https://github.com/acornjs/acorn/issues}{\texttt{report bugs}} or create pull requests on \href{https://github.com/acornjs/acorn}{\texttt{github}}.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5202}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5202}
...
\end{DoxyCode}
 \hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5203}{}\doxysubsection{\texorpdfstring{Importing acorn}{Importing acorn}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5203}
...
ESM is preferred, as it allows better editor auto-\/completions by offering Type\+Script support. For this reason, following examples will use ESM imports.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5204}{}\doxysubsection{\texorpdfstring{Interface}{Interface}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5204}
...
\item {\bfseries{source\+Type}}:\+ Indicate the mode the code should be parsed in. Can be either {\ttfamily "{}script"{}}, {\ttfamily "{}\doxylink{namespacemodule}{module}"{}} or {\ttfamily "{}commonjs"{}}. This influences global strict mode and parsing of {\ttfamily import} and {\ttfamily export} declarations.

{\bfseries{NOTE}}:\+ If set to {\ttfamily "{}\doxylink{namespacemodule}{module}"{}}, then static {\ttfamily import} /\+ {\ttfamily export} syntax will be valid, even if {\ttfamily ecma\+Version} is less than 6. If set to {\ttfamily "{}commonjs"{}}, it is the same as {\ttfamily "{}script"{}} except that the top-\/level scope behaves like a function.
...
\begin{DoxyItemize}
\item {\ttfamily \doxylink{namespaceblock}{block}}:\+ {\ttfamily true} if the comment is a block comment, false if it is a line comment.
...
{\bfseries{get\+Line\+Info}}{\ttfamily (input, offset)} can be used to get a {\ttfamily \{line, column\}} object for a given program string and offset.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5205}{}\doxysubsubsection{\texorpdfstring{The {\ttfamily Parser} class}{The {\ttfamily Parser} class}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5205}
...
The {\ttfamily extend} method takes any number of plugin values, and returns a new {\ttfamily Parser} class that includes the extra parser logic provided by the plugins.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5206}{}\doxysubsection{\texorpdfstring{Command line interface}{Command line interface}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5206}
...
\item {\ttfamily -\/-\/\doxylink{namespacemodule}{module}}:\+ Sets the parsing mode to {\ttfamily "{}\doxylink{namespacemodule}{module}"{}}. Is set to {\ttfamily "{}script"{}} otherwise.
...
The utility spits out the syntax tree as JSON data.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5207}{}\doxysubsection{\texorpdfstring{Existing plugins}{Existing plugins}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md5207}
