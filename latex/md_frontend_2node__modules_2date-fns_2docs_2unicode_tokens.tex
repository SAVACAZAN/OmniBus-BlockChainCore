...
\hypertarget{md_frontend_2node__modules_2date-fns_2docs_2unicode_tokens}{}\label{md_frontend_2node__modules_2date-fns_2docs_2unicode_tokens}\index{Unicode Tokens@{Unicode Tokens}}
\label{md_frontend_2node__modules_2date-fns_2docs_2unicode_tokens_autotoc_md6371}%
\Hypertarget{md_frontend_2node__modules_2date-fns_2docs_2unicode_tokens_autotoc_md6371}%
...
The tokens are different from Moment.\+js and other libraries that opted to use custom formatting rules. While usage of a standard ensures compatibility and the future of the library, it causes confusion that this document intends to resolve.\hypertarget{md_frontend_2node__modules_2date-fns_2docs_2unicode_tokens_autotoc_md6372}{}\doxysection{\texorpdfstring{Popular mistakes}{Popular mistakes}}\label{md_frontend_2node__modules_2date-fns_2docs_2unicode_tokens_autotoc_md6372}
