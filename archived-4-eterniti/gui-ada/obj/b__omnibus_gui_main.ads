...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_omnibus_gui_main" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#cb132019#;
   pragma Export (C, u00001, "omnibus_gui_mainB");
   ...
   u00185 : constant Version_32 := 16#f2e5f53a#;
   pragma Export (C, u00185, "exchange_managerB");
   u00186 : constant Version_32 := 16#20f0987d#;
   pragma Export (C, u00186, "exchange_managerS");
   u00187 : constant Version_32 := 16#e259c480#;
   pragma Export (C, u00187, "system__assertionsB");
   u00188 : constant Version_32 := 16#8e6aa005#;
   pragma Export (C, u00188, "system__assertionsS");
   u00189 : constant Version_32 := 16#8b2c6428#;
   pragma Export (C, u00189, "ada__assertionsB");
   u00190 : constant Version_32 := 16#cc3ec2fd#;
   pragma Export (C, u00190, "ada__assertionsS");
   u00191 : constant Version_32 := 16#6ae39b2f#;
   pragma Export (C, u00191, "system__bignumsB");
   u00192 : constant Version_32 := 16#eea053e4#;
   pragma Export (C, u00192, "system__bignumsS");
   u00193 : constant Version_32 := 16#63f4e145#;
   pragma Export (C, u00193, "system__shared_bignumsS");
   u00194 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00194, "system__concat_2B");
   u00195 : constant Version_32 := 16#1d92ac69#;
   pragma Export (C, u00195, "system__concat_2S");
   u00196 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00196, "system__concat_3B");
   u00197 : constant Version_32 := 16#2213c63c#;
   pragma Export (C, u00197, "system__concat_3S");
   u00198 : constant Version_32 := 16#afee46aa#;
   pragma Export (C, u00198, "vault_storageB");
   u00199 : constant Version_32 := 16#b2b4b254#;
   pragma Export (C, u00199, "vault_storageS");
   u00200 : constant Version_32 := 16#8d235f7e#;
   pragma Export (C, u00200, "ada__environment_variablesB");
   u00201 : constant Version_32 := 16#767099b7#;
   pragma Export (C, u00201, "ada__environment_variablesS");
   u00202 : constant Version_32 := 16#e483ae2d#;
   pragma Export (C, u00202, "interfaces__c__stringsB");
   u00203 : constant Version_32 := 16#bd4557ce#;
   pragma Export (C, u00203, "interfaces__c__stringsS");
   u00204 : constant Version_32 := 16#9e1315bc#;
   ...
   u00207 : constant Version_32 := 16#07dd39ad#;
   pragma Export (C, u00207, "system__communicationS");
   u00208 : constant Version_32 := 16#c9305dff#;
   pragma Export (C, u00208, "vault_cryptoB");
   u00209 : constant Version_32 := 16#96b4bb56#;
   pragma Export (C, u00209, "vault_cryptoS");
   u00210 : constant Version_32 := 16#5edfb397#;
   pragma Export (C, u00210, "win32_cryptS");
   u00211 : constant Version_32 := 16#a803cfca#;
   pragma Export (C, u00211, "vault_typesB");
   u00212 : constant Version_32 := 16#73c9ed24#;
   pragma Export (C, u00212, "vault_typesS");
   u00213 : constant Version_32 := 16#c5cedb27#;
   pragma Export (C, u00213, "vault_pipe_clientB");
   u00214 : constant Version_32 := 16#608929c3#;
   pragma Export (C, u00214, "vault_pipe_clientS");
   u00215 : constant Version_32 := 16#f4c0b377#;
   pragma Export (C, u00215, "win32_pipesS");
   u00216 : constant Version_32 := 16#2a9922b8#;
   pragma Export (C, u00216, "http_serverB");
   u00217 : constant Version_32 := 16#09ebbead#;
   pragma Export (C, u00217, "http_serverS");
   u00218 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00218, "gnatS");
   u00219 : constant Version_32 := 16#47d695ec#;
   pragma Export (C, u00219, "gnat__socketsB");
   u00220 : constant Version_32 := 16#528e8950#;
   pragma Export (C, u00220, "gnat__socketsS");
   u00221 : constant Version_32 := 16#f97657db#;
   pragma Export (C, u00221, "gnat__sockets__linker_optionsS");
   u00222 : constant Version_32 := 16#15e2b87e#;
   pragma Export (C, u00222, "gnat__sockets__pollB");
   u00223 : constant Version_32 := 16#20481925#;
   pragma Export (C, u00223, "gnat__sockets__pollS");
   u00224 : constant Version_32 := 16#930d23d1#;
   pragma Export (C, u00224, "gnat__sockets__thinB");
   u00225 : constant Version_32 := 16#add95e20#;
   pragma Export (C, u00225, "gnat__sockets__thinS");
   u00226 : constant Version_32 := 16#a02b8996#;
   pragma Export (C, u00226, "gnat__sockets__thin_commonB");
   u00227 : constant Version_32 := 16#c4885490#;
   pragma Export (C, u00227, "gnat__sockets__thin_commonS");
   u00228 : constant Version_32 := 16#ae5b86de#;
   pragma Export (C, u00228, "system__pool_globalB");
   u00229 : constant Version_32 := 16#1c3dab8f#;
   pragma Export (C, u00229, "system__pool_globalS");
   u00230 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00230, "system__memoryB");
   u00231 : constant Version_32 := 16#b0fd4384#;
   pragma Export (C, u00231, "system__memoryS");
   u00232 : constant Version_32 := 16#690693e0#;
   pragma Export (C, u00232, "system__storage_pools__subpoolsB");
   u00233 : constant Version_32 := 16#23a252fc#;
   pragma Export (C, u00233, "system__storage_pools__subpoolsS");
   u00234 : constant Version_32 := 16#3676fd0b#;
   pragma Export (C, u00234, "system__storage_pools__subpools__finalizationB");
   u00235 : constant Version_32 := 16#54c94065#;
   pragma Export (C, u00235, "system__storage_pools__subpools__finalizationS");
