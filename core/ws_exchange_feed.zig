...
pub const ExchangeFeed = struct {
    ...
    pub fn upsertPrice(self: *Self, exchange: []const u8, pair: []const u8, bid: u64, ask: u64) void {
    ...
    pub fn markExchangeFailed(self: *Self, exchange: []const u8) void {
        self.mutex.lock();
        defer self.mutex.unlock();
        var it = self.prices.iterator();
        while (it.next()) |entry| {
...
pub fn parseCoinbaseTicker(feed: *ExchangeFeed, body: []const u8) void {
...
pub fn parseKrakenMessage(feed: *ExchangeFeed, body: []const u8) void {
...
pub fn parseLcxMessage(feed: *ExchangeFeed, body: []const u8) void {
