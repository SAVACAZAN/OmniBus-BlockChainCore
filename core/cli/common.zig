...
pub const bip32_wallet = @import("../bip32_wallet.zig");
pub const secp256k1 = @import("../secp256k1.zig");
pub const wallet_mod = @import("../wallet.zig");
pub const bech32_mod = @import("../bech32.zig");
...
// ─── ANSI colors ────────────────────────────────────────────────────────────
pub var g_color: bool = true;

pub fn ansi(comptime code: []const u8) []const u8 {
...
pub const C_GRAY    = "\x1b[90m";
pub const C_MAGENTA = "\x1b[35m";

pub fn col(comptime code: []const u8) []const u8 {
...
pub fn kvLookup(args: Args, key: []const u8) ?[]const u8 {
    for (args.kvs) |kv| {
...
pub fn parseArgs(allocator: std.mem.Allocator, argv: []const [:0]u8) !Args {
    var out = Args{};
...
pub fn resolveEndpoint(args: Args) Endpoint {
    var ep = Endpoint{};
    ep.token = args.token;
...
pub fn rpcError(allocator: std.mem.Allocator, comptime fmt: []const u8, args: anytype) ![]u8 {
...
pub fn parse(allocator: std.mem.Allocator, json: []const u8) !Parsed {
...
pub fn extractResult(root: std.json.Value, err_msg: *[]const u8) ?std.json.Value {
    if (root != .object) {
...
pub fn jsonGetStr(obj: std.json.Value, key: []const u8) ?[]const u8 {
...
pub fn jsonGetU64(obj: std.json.Value, key: []const u8) u64 {
...
pub fn formatOmni(buf: []u8, sat: u64) ![]const u8 {
...
pub fn parseDay(block_height: u64) u64 {
    return block_height / BLOCKS_PER_DAY;
}

// ─── Subcommand: health ─────────────────────────────────────────────────────
pub fn cmdHealth(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdDeriveKey(allocator: std.mem.Allocator, args: Args) !u8 {
...
pub fn cmdWalletList(allocator: std.mem.Allocator, args: Args) !u8 {
...
pub fn cmdWalletSummary(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
...
pub fn cmdBalance(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const params = try std.fmt.allocPrint(allocator, "[\"{s}\"]", .{addr});
    defer allocator.free(params);
...
// ─── Subcommand: stake ──────────────────────────────────────────────────────
pub fn cmdStake(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
...
pub fn cmdReputation(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const params = try std.fmt.allocPrint(allocator, "[\"{s}\"]", .{addr});
    defer allocator.free(params);
...
pub fn cmdValidators(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
// ─── Subcommand: stakers ────────────────────────────────────────────────────
pub fn cmdStakers(allocator: std.mem.Allocator, ep: Endpoint, limit: u64, json_mode: bool) !u8 {
...
// ─── Subcommand: verify ─────────────────────────────────────────────────────
pub fn cmdVerify(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const stake_params = try std.fmt.allocPrint(allocator,
        "{{\"address\":\"{s}\"}}", .{addr});
    defer allocator.free(stake_params);
    const stake_resp = try rpcCall(allocator, ep, "getstake", stake_params);
...
// handlers stay short.
pub fn printRawJson(json: []const u8) !void {
    try stdout().print("{s}\n", .{json});
}

pub fn printRpcError(err_msg: []const u8) !void {
    try stderr().print("{s}RPC error:{s} {s}\n", .{ col(C_RED), rst(), err_msg });
}

// ─── Mnemonic + signing helpers ──────────────────────────────────────────
pub const SignKey = struct {
    privkey: [32]u8,
    pubkey: [33]u8,
};

pub const ResolveSignKeyError = error{
    NoMnemonic,
    BadMnemonic,
    BadPrivkey,
    BadKeyfile,
...
pub fn resolveSigningKey(allocator: std.mem.Allocator, args: Args) ResolveSignKeyError!SignKey {
...
pub fn requireYes(args: Args, label: []const u8) !u8 {
...
pub fn writeMissing(usage: []const u8) !u8 {
...
// numeric IDs.
pub fn parsePairId(s: []const u8) ?u16 {
    // Numeric path
...
/// scaled by 1e6.
pub fn parsePrice(s: []const u8) ?u64 {
...
pub fn parseOmni(s: []const u8) ?u64 {
    if (std.mem.indexOfScalar(u8, s, '.') == null) {
...
// ─── exchange-pairs ──────────────────────────────────────────────────────
pub fn cmdExchangePairs(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
// ─── exchange-orderbook ──────────────────────────────────────────────────
pub fn cmdExchangeOrderbook(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn renderOrderbook(allocator: std.mem.Allocator, r: std.json.Value, pid: u16) !u8 {
    _ = allocator;
    const out = stdout();
...
// ─── exchange-trades ─────────────────────────────────────────────────────
pub fn cmdExchangeTrades(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdExchangeOrders(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, args: Args) !u8 {
...
// ─── exchange-pair-info ──────────────────────────────────────────────────
pub fn cmdExchangePairInfo(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
// ─── exchange-stats ──────────────────────────────────────────────────────
pub fn cmdExchangeStats(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
// ─── exchange-place ──────────────────────────────────────────────────────
pub fn cmdExchangePlace(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
    if (args.pos.len < 5)
...
// ─── exchange-cancel ─────────────────────────────────────────────────────
pub fn cmdExchangeCancel(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
// ─── grid-list ───────────────────────────────────────────────────────────
pub fn cmdGridList(allocator: std.mem.Allocator, ep: Endpoint, owner: ?[]const u8, json_mode: bool) !u8 {
...
// ─── grid-status ─────────────────────────────────────────────────────────
pub fn cmdGridStatus(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
// ─── grid-create ─────────────────────────────────────────────────────────
pub fn cmdGridCreate(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
// ─── grid-cancel ─────────────────────────────────────────────────────────
pub fn cmdGridCancel(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
// ─── htlc-list ───────────────────────────────────────────────────────────
pub fn cmdHtlcList(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
// ─── htlc-status ─────────────────────────────────────────────────────────
pub fn cmdHtlcStatus(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdDexSettlerStatus(allocator: std.mem.Allocator, args: Args) !u8 {
    _ = allocator;
...
pub fn cmdHtlcInit(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdHtlcClaim(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdHtlcRefund(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdSwapList(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdSwapStatus(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdOraclePrices(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdOracleArbitrage(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdOracleFeed(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdBridgeStatus(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdBridgeLock(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn printWriteResult(allocator: std.mem.Allocator, resp: []const u8, label: []const u8) !u8 {
    var p = try parse(allocator, resp);
    defer p.deinit();
    var err_msg: []const u8 = "";
    const r = extractResult(p.value, &err_msg) orelse {
...
pub fn jsonGetF64(obj: std.json.Value, key: []const u8) f64 {
    if (obj != .object) return 0;
    const v = obj.object.get(key) orelse return 0;
    return switch (v) {
        .float => |f| f,
...
pub fn printJsonValue(w: anytype, v: std.json.Value, depth: usize) !void {
...
pub fn printIndent(w: anytype, depth: usize) !void {
    var i: usize = 0;
    while (i < depth) : (i += 1) try w.writeAll("  ");
}

// ─── Chain inspection ───────────────────────────────────────────────────────
pub fn cmdBlock(allocator: std.mem.Allocator, ep: Endpoint, height_str: []const u8, json_mode: bool) !u8 {
...
pub fn cmdBlockByHash(allocator: std.mem.Allocator, ep: Endpoint, hash: []const u8, json_mode: bool) !u8 {
...
pub fn cmdTx(allocator: std.mem.Allocator, ep: Endpoint, txid: []const u8, json_mode: bool) !u8 {
...
pub fn cmdMempool(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "getrawmempool", "[]", "Mempool", json_mode);
}

pub fn cmdSyncStatus(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdChainInfo(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "getchaininfo", "[]", "Chain Info", json_mode);
}

pub fn cmdSupply(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    const resp = try rpcCall(allocator, ep, "getchainmetrics", "[]");
    defer allocator.free(resp);
    if (json_mode) { try printRawJson(resp); return 0; }
    var p = parse(allocator, resp) catch return 1;
...
pub fn cmdHalving(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdSupply(allocator, ep, json_mode);
}

pub fn cmdPrices(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
// ─── Network / peers ────────────────────────────────────────────────────────
pub fn cmdPeers(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "getpeers", "[]", "Peers", json_mode);
}

pub fn cmdPeerInfo(allocator: std.mem.Allocator, ep: Endpoint, peer_id: []const u8, json_mode: bool) !u8 {
...
pub fn cmdBans(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "getbans", "[]", "Banned Peers", json_mode);
}

pub fn cmdConnectPeer(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdDisconnectPeer(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdP2pStats(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "getp2pstats", "[]", "P2P Stats", json_mode);
}

// ─── Mining ─────────────────────────────────────────────────────────────────
pub fn cmdMiningStatus(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdMiners(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "getminers", "[]", "Miners", json_mode);
}

pub fn cmdMinerStats(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const params = try std.fmt.allocPrint(allocator, "[\"{s}\"]", .{addr});
    defer allocator.free(params);
    return cmdGenericJson(allocator, ep, "getminerstats", params, "Miner Stats", json_mode);
}

pub fn cmdPoolStats(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "getpoolstats", "[]", "Pool Stats", json_mode);
}

pub fn cmdSlotLeader(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "getslotleader", "[]", "Slot Leader", json_mode);
}

pub fn cmdRegisterMiner(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
// ─── Wallet utilities ───────────────────────────────────────────────────────
pub fn cmdWalletDerive(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdWalletPqDerive(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdWalletMultichain(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdWalletExport(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdSignMessage(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdVerifySignature(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdSend(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdSetRpcToken(allocator: std.mem.Allocator, args: Args) !u8 {
...
pub fn cmdConfig(allocator: std.mem.Allocator, args: Args, ep: Endpoint) !u8 {
    const path = try configPath(allocator);
    defer allocator.free(path);
    const out = stdout();
...
pub fn cmdLogs(allocator: std.mem.Allocator, args: Args) !u8 {
...
pub fn runProcess(allocator: std.mem.Allocator, argv: []const []const u8) !u8 {
...
pub fn cmdVpsHealth(allocator: std.mem.Allocator) !u8 {
...
pub fn cmdStressQuick(allocator: std.mem.Allocator) !u8 {
    return runProcess(allocator, &.{
        "bash", "test-scripts/_quick-stake-test.sh",
    });
}

pub fn cmdBenchmark(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
    const out = stdout();
    if (!args.json) {
...
// ─── Faucet ─────────────────────────────────────────────────────────────────
pub fn cmdFaucetStatus(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "faucetstatus", "[]", "Faucet Status", json_mode);
}

pub fn cmdFaucetClaim(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdFaucetClaims(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "faucetclaims", "[]", "Faucet Claims", json_mode);
}

// ─── 0day / security ────────────────────────────────────────────────────────
pub fn cmdZerodayEvents(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "zerodayevents", "[]", "0day Events", json_mode);
}

pub fn cmdZerodayReport(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdSybilCheck(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdAuditTotals(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdAuditStakes(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdAuditSupply(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    const metrics_resp = try rpcCall(allocator, ep, "getchainmetrics", "[]");
    defer allocator.free(metrics_resp);
    var mp = parse(allocator, metrics_resp) catch return 1;
    defer mp.deinit();
...
pub fn cmdAuditMempool(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "auditmempool", "[]", "Mempool Audit", json_mode);
}

pub fn cmdAuditFees(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return cmdGenericJson(allocator, ep, "auditfees", "[]", "Fee Audit", json_mode);
}

// ─── Restart / control ──────────────────────────────────────────────────────
pub fn cmdServicesStatus(allocator: std.mem.Allocator) !u8 {
    return runProcess(allocator, &.{
        "ssh", "omnibus-vps",
...
pub fn cmdServiceRestart(allocator: std.mem.Allocator, args: Args) !u8 {
...
pub fn cmdOracleRestart(allocator: std.mem.Allocator, args: Args) !u8 {
...
pub fn cmdOracleSnapshot(allocator: std.mem.Allocator) !u8 {
...
// ─── ns-resolve ──────────────────────────────────────────────────────────
pub fn cmdNsResolve(allocator: std.mem.Allocator, ep: Endpoint, name: []const u8, json_mode: bool) !u8 {
...
// ─── ns-reverse ──────────────────────────────────────────────────────────
pub fn cmdNsReverse(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
...
// ─── ns-list ─────────────────────────────────────────────────────────────
pub fn cmdNsList(allocator: std.mem.Allocator, ep: Endpoint, owner: ?[]const u8, json_mode: bool) !u8 {
...
pub fn cmdNsTlds(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return dumpRpcResult(allocator, ep, "ns_listTlds", "[]", json_mode, "Available TLDs");
}

pub fn cmdNsFee(allocator: std.mem.Allocator, ep: Endpoint, tld: []const u8, json_mode: bool) !u8 {
...
pub fn cmdNsStats(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return dumpRpcResult(allocator, ep, "ns_stats", "[]", json_mode, "NS Stats");
}

pub fn cmdNsExpiring(allocator: std.mem.Allocator, ep: Endpoint, days: u64, json_mode: bool) !u8 {
...
pub fn cmdNsRegister(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdNsRenew(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdNsTransfer(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdNsUpdate(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdNsByCategory(allocator: std.mem.Allocator, ep: Endpoint, cat: []const u8, json_mode: bool) !u8 {
    const qc = try jsonQuote(allocator, cat);
    defer allocator.free(qc);
...
pub fn cmdAgentsList(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdAgentInfo(allocator: std.mem.Allocator, ep: Endpoint, agent_id: []const u8, json_mode: bool) !u8 {
...
pub fn cmdAgentRegister(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdAgentUnregister(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdAgentEdit(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdAgentFollow(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdAgentDecisions(allocator: std.mem.Allocator, ep: Endpoint, agent_id: []const u8, json_mode: bool) !u8 {
    const params = try std.fmt.allocPrint(allocator, "[{s}]", .{agent_id});
    defer allocator.free(params);
...
pub fn cmdGovProposals(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdGovProposal(allocator: std.mem.Allocator, ep: Endpoint, pid: []const u8, json_mode: bool) !u8 {
...
pub fn cmdGovPropose(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdGovVote(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdGovExecute(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdGovTreasury(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
...
pub fn cmdEscrowList(allocator: std.mem.Allocator, ep: Endpoint, addr: ?[]const u8, json_mode: bool) !u8 {
...
pub fn cmdEscrowCreate(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdEscrowInfo(allocator: std.mem.Allocator, ep: Endpoint, eid: []const u8, json_mode: bool) !u8 {
...
pub fn cmdChannelsList(allocator: std.mem.Allocator, ep: Endpoint, addr: ?[]const u8, json_mode: bool) !u8 {
    const params = if (addr) |a| blk: {
        const qa = try jsonQuote(allocator, a);
        defer allocator.free(qa);
        break :blk try std.fmt.allocPrint(allocator, "[{s}]", .{qa});
...
pub fn cmdChannelOpen(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdChannelPay(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdChannelClose(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdChannelInfo(allocator: std.mem.Allocator, ep: Endpoint, cid: []const u8, json_mode: bool) !u8 {
...
pub fn cmdNotarizeList(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const qa = try jsonQuote(allocator, addr);
    defer allocator.free(qa);
    const params = try std.fmt.allocPrint(allocator, "[{s}]", .{qa});
    defer allocator.free(params);
...
pub fn cmdNotarizeDoc(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdNotarizeVerify(allocator: std.mem.Allocator, ep: Endpoint, hash: []const u8, json_mode: bool) !u8 {
...
pub fn cmdNotarizeRevoke(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdSubList(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const qa = try jsonQuote(allocator, addr);
    defer allocator.free(qa);
    const params = try std.fmt.allocPrint(allocator, "[{s}]", .{qa});
    defer allocator.free(params);
...
pub fn cmdSubCreate(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdSubCancel(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdMultisigCreate(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdMultisigInfo(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const qa = try jsonQuote(allocator, addr);
    defer allocator.free(qa);
    const params = try std.fmt.allocPrint(allocator, "[{s}]", .{qa});
    defer allocator.free(params);
...
pub fn cmdMultisigSend(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdPqAttest(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdPqIdentity(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const qa = try jsonQuote(allocator, addr);
    defer allocator.free(qa);
    const params = try std.fmt.allocPrint(allocator, "[{s}]", .{qa});
    defer allocator.free(params);
...
pub fn cmdPqBalance(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const qa = try jsonQuote(allocator, addr);
    defer allocator.free(qa);
    const params = try std.fmt.allocPrint(allocator, "[{s}]", .{qa});
    defer allocator.free(params);
...
pub fn cmdPqSchemes(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return dumpRpcResult(allocator, ep, "pq_listSchemes", "[]", json_mode, "PQ Schemes");
}

// ─── POAP / Social ───────────────────────────────────────────────────────
pub fn cmdPoapEvents(allocator: std.mem.Allocator, ep: Endpoint, json_mode: bool) !u8 {
    return dumpRpcResult(allocator, ep, "getpoaps", "[]", json_mode, "POAP Events");
}

pub fn cmdPoapClaim(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdFollow(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdFollowers(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const qa = try jsonQuote(allocator, addr);
    defer allocator.free(qa);
    const params = try std.fmt.allocPrint(allocator, "[{s}]", .{qa});
    defer allocator.free(params);
...
pub fn cmdFollowing(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const qa = try jsonQuote(allocator, addr);
    defer allocator.free(qa);
    const params = try std.fmt.allocPrint(allocator, "[{s}]", .{qa});
    defer allocator.free(params);
...
pub fn resolveProfileAddress(allocator: std.mem.Allocator, args: Args, pos_idx: usize) !?[]u8 {
...
pub fn parsePublicFlag(args: Args) bool {
...
pub fn cmdProfileInit(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdProfileGet(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    const qa = try jsonQuote(allocator, addr);
    defer allocator.free(qa);
    const params = try std.fmt.allocPrint(allocator, "[{s}]", .{qa});
    defer allocator.free(params);
...
pub fn cmdProfileSocial(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdProfileProfessional(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdProfileCultural(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdProfileEconomic(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn readLineAlloc(allocator: std.mem.Allocator, reader: anytype, max: usize) !?[]u8 {
    var b = std.array_list.Managed(u8).init(allocator);
    defer b.deinit();
...
pub fn promptYesNo(allocator: std.mem.Allocator, reader: anytype, prompt: []const u8) !bool {
...
pub fn promptString(allocator: std.mem.Allocator, reader: anytype, prompt: []const u8) !?[]u8 {
...
pub fn cmdProfileWizard(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdProfileExport(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdProfileImport(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdProfile(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
    if (args.pos.len < 1) {
...
pub fn cmdMicaAttest(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdMicaDisclose(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
    const addr_opt = try resolveProfileAddress(allocator, args, 1);
    if (addr_opt == null) return 2;
    const addr = addr_opt.?;
    defer allocator.free(addr);
...
pub fn cmdMica(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
    if (args.pos.len < 1) {
...
pub fn cmdColdwalletAdd(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdColdwalletList(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdColdwalletRemove(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdColdwalletHistory(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdColdwalletBalance(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    // Just calls getbalance — cold wallets are watch-only.
    return cmdBalance(allocator, ep, addr, json_mode);
}

pub fn cmdColdwallet(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
    if (args.pos.len < 1) {
...
pub fn cmdTimelockCreate(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdTimelockList(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdTimelockSpend(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdTimelockStatus(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdTimelock(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
    if (args.pos.len < 1) {
...
pub fn cmdCovenantCreate(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdCovenantList(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdCovenantGet(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdCovenantRemove(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdCovenant(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
    if (args.pos.len < 1) {
...
pub fn cmdTreasuryCreate(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdTreasuryList(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdTreasuryDistribute(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdTreasuryStatus(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
...
pub fn cmdTreasury(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
    if (args.pos.len < 1) {
...
pub fn cmdMultisigBalance(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
    return cmdBalance(allocator, ep, addr, json_mode);
}

pub fn cmdMultisigInfoFull(allocator: std.mem.Allocator, ep: Endpoint, addr: []const u8, json_mode: bool) !u8 {
...
pub fn cmdMultisig(allocator: std.mem.Allocator, ep: Endpoint, args: Args) !u8 {
    if (args.pos.len < 1) {
