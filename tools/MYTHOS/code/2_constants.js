...
// Exploits
export async function listExploitBlocks({ blocksDir }) {
  return await invoke('list_exploit_blocks', { blocksDir });
}

export async function getBlockContent({ filePath }) {
  return await invoke('get_block_content', { filePath });
}