...
CATEGORIES = [
    ...
    },
    {
        ...
        "items": [
            ...
            ("Passphrase (25th word)", True, "bip32_wallet.zig", "Partial (TODO)"),
    ...
    },
    {
        ...
        "items": [
            ("UTXO Model", True, "state_trie.zig", "Account-based (partial UTXO)"),
            ...
            ("Change Address (chain=1)", True, None, "NOT YET IMPLEMENTED"),
            ...
            ("Sequence Number", True, None, "NOT YET"),
            ("Witness Data (SegWit)", True, "transaction.zig", "script_sig field (partial)"),
            ("Replace-By-Fee (RBF)", True, None, "NOT YET"),
            ("Child-Pays-For-Parent", True, None, "NOT YET"),
    ...
    },
    {
        ...
        "items": [
            ...
            ("Tor Support", True, None, "NOT YET"),
            ("I2P Support", True, None, "NOT YET"),
            ("BIP-324 Encrypted P2P", True, None, "NOT YET"),
    ...
    },
    {
        ...
        "items": [
            ...
            ("UTXO Index", True, "state_trie.zig", "Account-based (partial)"),
    ...
    },
    {
        ...
        "items": [
            ...
            ("Lightning Network", True, None, "NOT YET (channels exist)"),
            ("HTLC Contracts", True, None, "NOT YET"),
            ("Sidechain Support", True, None, "NOT YET (bridge exists)"),
    ...
    },
    {
        ...
        "items": [
            ...
            ("BIP-174 (PSBT)", True, None, "NOT YET"),
            ("BIP-324 (V2 P2P)", True, None, "NOT YET"),
            ("BIP-152 (Compact Blocks)", True, "binary_codec.zig", "Partial"),
            ("BIP-157/158 (Filters)", True, None, "NOT YET"),
            ("BIP-199 (HTLC)", True, None, "NOT YET"),
        ]
    },
]
