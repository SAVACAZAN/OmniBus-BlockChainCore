...
const addr = "ob1q8wm5est4fft7mrj937sg9uyaz2nskgttf3ku5u";
...
const payload = `{"trader":"${addr}","side":"${side}","pairId":${pairId},"price":${price},"amount":${amount},"nonce":${nonce},"signature":"${Buffer.from(sig.toCompactRawBytes()).toString("hex")}","publicKey":"${Buffer.from(leaf.publicKey).toString("hex")}","evmOrderId":1778935851833956}`;
console.log(payload);
